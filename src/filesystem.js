...
fileSystem.factory('fileSystem', ['$q', '$timeout', function ($q, $timeout) {
    ...
    window.webkitStorageInfo.requestQuota(window.TEMPORARY, DEFAULT_QUOTA_MB * 1024 * 1024, function (grantedBytes) {
        if (window.cordova) {
    ...
    var fileSystem = {
        ...
        getCurrentUsage: function () {
            ...
            webkitStorageInfo.queryUsageAndQuota(window.TEMPORARY, function (used, quota) {
        ...
        requestQuota: function (newQuotaMB) {
            ...
            window.webkitStorageInfo.requestQuota(window.TEMPORARY, newQuotaMB * 1024 * 1024, function (grantedBytes) {
